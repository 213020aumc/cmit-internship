...
// Helper for consistent JSON envelopes
...
export const createTask = async (req, res) => {
  // req.body has already been validated and sanitized by Joi middleware
...
export const updateTask = async (req, res) => {
  ...
  // req.body has been validated and sanitized by Joi middleware
